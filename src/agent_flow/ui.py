    ...
    try:
        ...
        for name, agent in spec.agents.items():
            ...
            agents_info[name] = {
                ...
                "has_handoffs": len(getattr(agent, "handoffs", [])) > 0,
            }
...
def start_ui(host: str = "0.0.0.0", port: int = 7000, rebuild: bool = False):
    """
    Start the UI server.
    ...
    import uvicorn
    print(f"\n🚀 Starting Agent Flow Playground at http://localhost:{port}\n")
